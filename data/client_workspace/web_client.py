...
<body>
    <div class="container mt-4">
        <h2 class="text-center mb-4">🛡️ Post-Quantum Vault System</h2>
        
        <div class="crypto-panel d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-0">⚙️ Crypto-Agility Framework</h5>
            ...
            <select id="cryptoMode" class="form-select w-auto bg-dark text-white border-secondary">
                <option value="pqc">🛡️ Post-Quantum (ML-KEM + ML-DSA)</option>
                <option value="classical">🏛️ Classical (X25519 ECC)</option>
                <option value="hybrid">⚔️ Hybrid (X25519 + ML-KEM)</option>
            </select>
        </div>
